export default {
  ...
  PROFILE_REMINDERS_NONE_ACTIVE: 'कोई सक्रिय नहीं',
  PROFILE_REMINDERS_COUNT_ACTIVE: '{{count}} सक्रिय रिमाइंडर',
  PROFILE_IMAGE_MODAL_TITLE: 'प्रोफ़ाइल फ़ोटो',
  PROFILE_IMAGE_MODAL_DESC: 'नई फ़ोटो खींचें या अपनी गैलरी से चुनें',
  PROFILE_IMAGE_CAMERA: 'कैमरा से फ़ोटो लें',
  PROFILE_IMAGE_GALLERY: 'गैलरी से चुनें',
  PROFILE_IMAGE_REMOVE: 'फ़ोटो हटाएं',
  PERMISSION_CAMERA_TITLE: 'कैमरा अनुमति',
  PERMISSION_CAMERA_MESSAGE:
    'प्रोफ़ाइल फ़ोटो लेने के लिए GuruVani को कैमरे की अनुमति की आवश्यकता है।',
  PERMISSION_REQUIRED_TITLE: 'अनुमति आवश्यक',
  PERMISSION_REQUIRED_MESSAGE:
    'इस सुविधा का उपयोग करने के लिए GuruVani को अनुमति की आवश्यकता है।',
  PERMISSION_ASK_LATER: 'बाद में पूछें',
  ...
  TEMPLE_NOT_FOUND: 'मंदिर की जानकारी उपलब्ध नहीं है',
  COMMON_GO_BACK: 'वापस जाएँ',
  TEMPLE_LOCATION_LABEL: 'स्थान',
  TEMPLE_BADGE_CHARDHAM: 'चार महाधाम',
  TEMPLE_BADGE_JYOTIRLINGA: 'द्वादश ज्योतिर्लिंग',
  TEMPLE_BADGE_SHAKTIPEETH: 'शक्तिपीठ',
  TEMPLE_NEARBY_PLACES_LABEL: 'निकटवर्ती प्रमुख स्थल',
