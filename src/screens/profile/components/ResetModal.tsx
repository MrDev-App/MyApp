    ...
    <OverlayModal ref={modalRef} closeOnBackdropPress={true}>
      ...
      >
        <View style={profileStyles.modalCenterContainer}>
          <View
            style={[profileStyles.modalCard, { maxHeight: verticalScale(520) }]}
          >
            <ScrollView
            ...
            >
              ...
              >
                <View
                  style={[
                    ...
                    checkedChants && profileStyles.checkboxActive,
                  ]}
                >
                  {checkedChants && (
                    <Text style={profileStyles.checkboxTick}>✓</Text>
                  )}
                </View>
              ...
              >
                <View
                  style={[
                    profileStyles.checkbox,
                    checkedChallenge && profileStyles.checkboxActive,
                  ]}
                >
                  {checkedChallenge && (
                    <Text style={profileStyles.checkboxTick}>✓</Text>
