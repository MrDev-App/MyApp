...
const FavoriteStoriesSection: React.FC<FavoriteStoriesSectionProps> = ({
  ...
  return (
    <View style={profileStyles.sectionContainer}>
      <Text style={profileStyles.rowTitle}>
      ...
      >
        {stories.map(story => {
          ...
          const category =
            currentLanguage === 'hi' ? story.categoryHi : story.categoryEn;
          return (
            <TouchableOpacity
              key={story.id}
            ...
            >
              <View style={profileStyles.bookCoverContainer}>
                ...
                <Image
                  source={story.image}
                  style={profileStyles.bookCoverImage}
                />
                <View style={profileStyles.categoryBadge}>
                  <Text style={profileStyles.categoryBadgeText}>
                    {category}
                  </Text>
                </View>
              </View>
