...
const MantraScreen = () => {
  ...
  const allGods: God[] = route.params?.allGods || (initialGod ? [initialGod] : []);
    ...
    <SafeAreaView style={styles.safeArea} edges={['top', 'bottom']}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle} numberOfLines={1}>
          {godName ? `${godName} ${isHindi ? 'मंत्र' : 'Mantras'}` : isHindi ? 'मंत्र संग्रह' : 'Sacred Mantras'}
        </Text>
      ...
      >
          ...
          <View style={styles.showcaseCard}>
            ...
            <View style={styles.badgeContainer}>
              <Text style={styles.badgeText}>
                {`${mantras.length} ${isHindi ? 'पवित्र मंत्र' : 'Sacred Mantras'}`}
              </Text>
            </View>
          </View>
        )}
        ...
        <View style={styles.mantrasHeaderRow}>
          ...
          <Text style={styles.mantrasCountText}>
            {isHindi ? 'पढ़ने के लिए कार्ड पर टैप करें' : 'Tap to read & chant'}
          </Text>
        </View>
        ...
        {mantras.map((m, index) => {
          ...
          return (
            ...
            >
              ...
              <View style={styles.mantraCardFooter}>
      ...
      {/* Single Top-Level Mantra Detail Modal (Zero nested modals) */}
      <Modal
                ...
                <View style={styles.modalActionsRow}>
                  ...
                  >
                    <Text style={styles.startJapBtnText}>
                      {isHindi ? '📿 इस मंत्र से जाप करें' : '📿 Start Jap with this Mantra'}
                    </Text>
                  </TouchableOpacity>
